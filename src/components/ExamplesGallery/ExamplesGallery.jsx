...
const items = [
  ...
  },
  {
    ...
    text: "Собрали варианты под задачу компании: брендируемые элементы, универсальные подарки и веселой атмосферы.",
  },
  {
    id: 4,
    image: example4,
  ...
  },
  {
    ...
    text: "Очень сладкий и запоминающийся подарок на день рождение: что-то можно съесть сразу, а что-то останется на всю жизнь и будет напоминать о том кто сделал этот подарок.",
  },
];
